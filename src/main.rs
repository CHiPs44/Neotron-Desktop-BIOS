...
extern "C" fn hid_get_event() -> common::ApiResult<common::FfiOption<common::hid::HidEvent>> {
	...
	match queue.as_ref().unwrap().try_recv() {
		Ok(AppEvent::KeyUp(scan)) => {
			let code = common::hid::HidEvent::KeyRelease(convert_scancode(scan));
			debug!("hid_get_event({:?}) -> {:?}", scan, code);
			common::ApiResult::Ok(common::FfiOption::Some(code))
		}
		Ok(AppEvent::KeyDown(scan)) => {
			let code = common::hid::HidEvent::KeyPress(convert_scancode(scan));
			debug!("hid_get_event({:?}) -> {:?}", scan, code);
			common::ApiResult::Ok(common::FfiOption::Some(code))
		}
...
/// Convert a pix-engine scancode into a Neotron BIOS keycode
fn convert_scancode(scan: Scan) -> common::hid::KeyCode {
	match scan {
		Scan::Backspace => common::hid::KeyCode::Backspace,
		Scan::Tab => common::hid::KeyCode::Tab,
		Scan::Return => common::hid::KeyCode::Return,
		Scan::Escape => common::hid::KeyCode::Escape,
		Scan::Space => common::hid::KeyCode::Spacebar,
		// Scan::Exclaim => common::hid::KeyCode::Exclaim,
		// Scan::Quotedbl => common::hid::KeyCode::Quotedbl,
		Scan::Hash => common::hid::KeyCode::Oem7,
		// Scan::Dollar => common::hid::KeyCode::Dollar,
		// Scan::Percent => common::hid::KeyCode::Percent,
		// Scan::Ampersand => common::hid::KeyCode::Ampersand,
		Scan::Quote => common::hid::KeyCode::Oem3,
		// Scan::LeftParen => common::hid::KeyCode::LeftParen,
		// Scan::RightParen => common::hid::KeyCode::RightParen,
		// Scan::Asterisk => common::hid::KeyCode::Asterisk,
		// Scan::Plus => common::hid::KeyCode::Plus,
		Scan::Comma => common::hid::KeyCode::OemComma,
		Scan::Minus => common::hid::KeyCode::OemMinus,
		Scan::Period => common::hid::KeyCode::OemPeriod,
		Scan::Slash => common::hid::KeyCode::Oem2,
		Scan::Num0 => common::hid::KeyCode::Key0,
		Scan::Num1 => common::hid::KeyCode::Key1,
		Scan::Num2 => common::hid::KeyCode::Key2,
		Scan::Num3 => common::hid::KeyCode::Key3,
		Scan::Num4 => common::hid::KeyCode::Key4,
		Scan::Num5 => common::hid::KeyCode::Key5,
		Scan::Num6 => common::hid::KeyCode::Key6,
		Scan::Num7 => common::hid::KeyCode::Key7,
		Scan::Num8 => common::hid::KeyCode::Key8,
		Scan::Num9 => common::hid::KeyCode::Key9,
		// Scan::Colon => common::hid::KeyCode::Colon,
		Scan::Semicolon => common::hid::KeyCode::Oem1,
		// Scan::Less => common::hid::KeyCode::Less,
		Scan::Equals => common::hid::KeyCode::OemPlus,
		// Scan::Greater => common::hid::KeyCode::Greater,
		// Scan::Question => common::hid::KeyCode::Question,
		// Scan::At => common::hid::KeyCode::At,
		Scan::LeftBracket => common::hid::KeyCode::Oem4,
		Scan::Backslash => common::hid::KeyCode::Oem5,
		Scan::RightBracket => common::hid::KeyCode::Oem6,
		// Scan::Caret => common::hid::KeyCode::Caret,
		// Scan::Underscore => common::hid::KeyCode::Underscore,
		Scan::Backquote => common::hid::KeyCode::Oem8,
		Scan::A => common::hid::KeyCode::A,
		Scan::B => common::hid::KeyCode::B,
		Scan::C => common::hid::KeyCode::C,
		Scan::D => common::hid::KeyCode::D,
		Scan::E => common::hid::KeyCode::E,
		Scan::F => common::hid::KeyCode::F,
		Scan::G => common::hid::KeyCode::G,
		Scan::H => common::hid::KeyCode::H,
		Scan::I => common::hid::KeyCode::I,
		Scan::J => common::hid::KeyCode::J,
		Scan::K => common::hid::KeyCode::K,
		Scan::L => common::hid::KeyCode::L,
		Scan::M => common::hid::KeyCode::M,
		Scan::N => common::hid::KeyCode::N,
		Scan::O => common::hid::KeyCode::O,
		Scan::P => common::hid::KeyCode::P,
		Scan::Q => common::hid::KeyCode::Q,
		Scan::R => common::hid::KeyCode::R,
		Scan::S => common::hid::KeyCode::S,
		Scan::T => common::hid::KeyCode::T,
		Scan::U => common::hid::KeyCode::U,
		Scan::V => common::hid::KeyCode::V,
		Scan::W => common::hid::KeyCode::W,
		Scan::X => common::hid::KeyCode::X,
		Scan::Y => common::hid::KeyCode::Y,
		Scan::Z => common::hid::KeyCode::Z,
		Scan::Delete => common::hid::KeyCode::Delete,
		Scan::CapsLock => common::hid::KeyCode::CapsLock,
		Scan::F1 => common::hid::KeyCode::F1,
		Scan::F2 => common::hid::KeyCode::F2,
		Scan::F3 => common::hid::KeyCode::F3,
		Scan::F4 => common::hid::KeyCode::F4,
		Scan::F5 => common::hid::KeyCode::F5,
		Scan::F6 => common::hid::KeyCode::F6,
		Scan::F7 => common::hid::KeyCode::F7,
		Scan::F8 => common::hid::KeyCode::F8,
		Scan::F9 => common::hid::KeyCode::F9,
		Scan::F10 => common::hid::KeyCode::F10,
		Scan::F11 => common::hid::KeyCode::F11,
		Scan::F12 => common::hid::KeyCode::F12,
		Scan::PrintScreen => common::hid::KeyCode::PrintScreen,
		Scan::ScrollLock => common::hid::KeyCode::ScrollLock,
		Scan::Pause => common::hid::KeyCode::PauseBreak,
		Scan::Insert => common::hid::KeyCode::Insert,
		Scan::Home => common::hid::KeyCode::Home,
		Scan::PageUp => common::hid::KeyCode::PageUp,
		Scan::End => common::hid::KeyCode::End,
		Scan::PageDown => common::hid::KeyCode::PageDown,
		Scan::Right => common::hid::KeyCode::ArrowRight,
		Scan::Left => common::hid::KeyCode::ArrowLeft,
		Scan::Down => common::hid::KeyCode::ArrowDown,
		Scan::Up => common::hid::KeyCode::ArrowUp,
		Scan::NumLock => common::hid::KeyCode::NumpadLock,
		Scan::KpDivide => common::hid::KeyCode::NumpadDivide,
		Scan::KpMultiply => common::hid::KeyCode::NumpadMultiply,
		Scan::KpMinus => common::hid::KeyCode::NumpadSubtract,
		Scan::KpPlus => common::hid::KeyCode::NumpadAdd,
		Scan::KpEnter => common::hid::KeyCode::NumpadEnter,
		Scan::Kp1 => common::hid::KeyCode::Numpad1,
		Scan::Kp2 => common::hid::KeyCode::Numpad2,
		Scan::Kp3 => common::hid::KeyCode::Numpad3,
		Scan::Kp4 => common::hid::KeyCode::Numpad4,
		Scan::Kp5 => common::hid::KeyCode::Numpad5,
		Scan::Kp6 => common::hid::KeyCode::Numpad6,
		Scan::Kp7 => common::hid::KeyCode::Numpad7,
		Scan::Kp8 => common::hid::KeyCode::Numpad8,
		Scan::Kp9 => common::hid::KeyCode::Numpad9,
		Scan::Kp0 => common::hid::KeyCode::Numpad0,
		Scan::KpPeriod => common::hid::KeyCode::NumpadPeriod,
		// Scan::KpEquals => common::hid::KeyCode::KpEquals,
		// Scan::KpComma => common::hid::KeyCode::KpComma,
		Scan::LCtrl => common::hid::KeyCode::LControl,
		Scan::LShift => common::hid::KeyCode::LShift,
		Scan::LAlt => common::hid::KeyCode::LAlt,
		Scan::LGui => common::hid::KeyCode::LWin,
		Scan::RCtrl => common::hid::KeyCode::RControl,
		Scan::RShift => common::hid::KeyCode::RShift,
		Scan::RAlt => common::hid::KeyCode::RAltGr,
		Scan::RGui => common::hid::KeyCode::RWin,
		// Added by CHiPs44
		// Scan::NonUsHash => common::hid::KeyCode::,
		// Scan::Apostrophe => common::hid::KeyCode::,
		Scan::Grave => common::hid::KeyCode::Oem8, // Azerty '²'
		// Scan::NonUsBackslash => common::hid::KeyCode::,
		// Scan::Application => common::hid::KeyCode::,
		// Scan::Power => common::hid::KeyCode::,
		// Scan::F13 => common::hid::KeyCode::,
		// Scan::F14 => common::hid::KeyCode::,
		// Scan::F15 => common::hid::KeyCode::,
		// Scan::F16 => common::hid::KeyCode::,
		// Scan::F17 => common::hid::KeyCode::,
		// Scan::F18 => common::hid::KeyCode::,
		// Scan::F19 => common::hid::KeyCode::,
		// Scan::F20 => common::hid::KeyCode::,
		// Scan::F21 => common::hid::KeyCode::,
		// Scan::F22 => common::hid::KeyCode::,
		// Scan::F23 => common::hid::KeyCode::,
		// Scan::F24 => common::hid::KeyCode::,
		// Scan::Execute => common::hid::KeyCode::,
		// Scan::Help => common::hid::KeyCode::,
		// Scan::Menu => common::hid::KeyCode::,
		// Scan::Select => common::hid::KeyCode::,
		// Scan::Stop => common::hid::KeyCode::,
		// Scan::Again => common::hid::KeyCode::,
		// Scan::Undo => common::hid::KeyCode::,
		// Scan::Cut => common::hid::KeyCode::,
		// Scan::Copy => common::hid::KeyCode::,
		// Scan::Paste => common::hid::KeyCode::,
		// Scan::Find => common::hid::KeyCode::,
		// Scan::Mute => common::hid::KeyCode::,
		// Scan::VolumeUp => common::hid::KeyCode::,
		// Scan::VolumeDown => common::hid::KeyCode::,
		// Scan::KpEqualsAS400 => common::hid::KeyCode::,
		// Scan::International1 => common::hid::KeyCode::,
		// Scan::International2 => common::hid::KeyCode::,
		// Scan::International3 => common::hid::KeyCode::,
		// Scan::International4 => common::hid::KeyCode::,
		// Scan::International5 => common::hid::KeyCode::,
		// Scan::International6 => common::hid::KeyCode::,
		// Scan::International7 => common::hid::KeyCode::,
		// Scan::International8 => common::hid::KeyCode::,
		// Scan::International9 => common::hid::KeyCode::,
		// Scan::Lang1 => common::hid::KeyCode::,
		// Scan::Lang2 => common::hid::KeyCode::,
		// Scan::Lang3 => common::hid::KeyCode::,
		// Scan::Lang4 => common::hid::KeyCode::,
		// Scan::Lang5 => common::hid::KeyCode::,
		// Scan::Lang6 => common::hid::KeyCode::,
		// Scan::Lang7 => common::hid::KeyCode::,
		// Scan::Lang8 => common::hid::KeyCode::,
		// Scan::Lang9 => common::hid::KeyCode::,
		// Scan::AltErase => common::hid::KeyCode::,
		// Scan::SysReq => common::hid::KeyCode::,
		// Scan::Cancel => common::hid::KeyCode::,
		// Scan::Clear => common::hid::KeyCode::,
		// Scan::Prior => common::hid::KeyCode::,
		// Scan::Return2 => common::hid::KeyCode::,
		// Scan::Separator => common::hid::KeyCode::,
		// Scan::Out => common::hid::KeyCode::,
		// Scan::Oper => common::hid::KeyCode::,
		// Scan::ClearAgain => common::hid::KeyCode::,
		// Scan::CrSel => common::hid::KeyCode::,
		// Scan::ExSel => common::hid::KeyCode::,
		// Scan::Kp00 => common::hid::KeyCode::,
		// Scan::Kp000 => common::hid::KeyCode::,
		// Scan::ThousandsSeparator => common::hid::KeyCode::,
		// Scan::DecimalSeparator => common::hid::KeyCode::,
		// Scan::CurrencyUnit => common::hid::KeyCode::,
		// Scan::CurrencySubUnit => common::hid::KeyCode::,
		// Scan::KpLeftParen => common::hid::KeyCode::,
		// Scan::KpRightParen => common::hid::KeyCode::,
		// Scan::KpLeftBrace => common::hid::KeyCode::,
		// Scan::KpRightBrace => common::hid::KeyCode::,
		// Scan::KpTab => common::hid::KeyCode::,
		// Scan::KpBackspace => common::hid::KeyCode::,
		// Scan::KpA => common::hid::KeyCode::,
		// Scan::KpB => common::hid::KeyCode::,
		// Scan::KpC => common::hid::KeyCode::,
		// Scan::KpD => common::hid::KeyCode::,
		// Scan::KpE => common::hid::KeyCode::,
		// Scan::KpF => common::hid::KeyCode::,
		// Scan::KpXor => common::hid::KeyCode::,
		// Scan::KpPower => common::hid::KeyCode::,
		// Scan::KpPercent => common::hid::KeyCode::,
		// Scan::KpLess => common::hid::KeyCode::,
		// Scan::KpGreater => common::hid::KeyCode::,
		// Scan::KpAmpersand => common::hid::KeyCode::,
		// Scan::KpDblAmpersand => common::hid::KeyCode::,
		// Scan::KpVerticalBar => common::hid::KeyCode::,
		// Scan::KpDblVerticalBar => common::hid::KeyCode::,
		// Scan::KpColon => common::hid::KeyCode::,
		// Scan::KpHash => common::hid::KeyCode::,
		// Scan::KpSpace => common::hid::KeyCode::,
		// Scan::KpAt => common::hid::KeyCode::,
		// Scan::KpExclam => common::hid::KeyCode::,
		// Scan::KpMemStore => common::hid::KeyCode::,
		// Scan::KpMemRecall => common::hid::KeyCode::,
		// Scan::KpMemClear => common::hid::KeyCode::,
		// Scan::KpMemAdd => common::hid::KeyCode::,
		// Scan::KpMemSubtract => common::hid::KeyCode::,
		// Scan::KpMemMultiply => common::hid::KeyCode::,
		// Scan::KpMemDivide => common::hid::KeyCode::,
		// Scan::KpPlusMinus => common::hid::KeyCode::,
		// Scan::KpClear => common::hid::KeyCode::,
		// Scan::KpClearEntry => common::hid::KeyCode::,
		// Scan::KpBinary => common::hid::KeyCode::,
		// Scan::KpOctal => common::hid::KeyCode::,
		// Scan::KpDecimal => common::hid::KeyCode::,
		// Scan::KpHexadecimal => common::hid::KeyCode::,
		// Scan::Mode => common::hid::KeyCode::,
		// Scan::AudioNext => common::hid::KeyCode::,
		// Scan::AudioPrev => common::hid::KeyCode::,
		// Scan::AudioStop => common::hid::KeyCode::,
		// Scan::AudioPlay => common::hid::KeyCode::,
		// Scan::AudioMute => common::hid::KeyCode::,
		// Scan::MediaSelect => common::hid::KeyCode::,
		// Scan::Www => common::hid::KeyCode::,
		// Scan::Mail => common::hid::KeyCode::,
		// Scan::Calculator => common::hid::KeyCode::,
		// Scan::Computer => common::hid::KeyCode::,
		// Scan::AcSearch => common::hid::KeyCode::,
		// Scan::AcHome => common::hid::KeyCode::,
		// Scan::AcBack => common::hid::KeyCode::,
		// Scan::AcForward => common::hid::KeyCode::,
		// Scan::AcStop => common::hid::KeyCode::,
		// Scan::AcRefresh => common::hid::KeyCode::,
		// Scan::AcBookmarks => common::hid::KeyCode::,
		// Scan::BrightnessDown => common::hid::KeyCode::,
		// Scan::BrightnessUp => common::hid::KeyCode::,
		// Scan::DisplaySwitch => common::hid::KeyCode::,
		// Scan::KbdIllumToggle => common::hid::KeyCode::,
		// Scan::KbdIllumDown => common::hid::KeyCode::,
		// Scan::KbdIllumUp => common::hid::KeyCode::,
		// Scan::Eject => common::hid::KeyCode::,
		// Scan::Sleep => common::hid::KeyCode::,
		// Scan::App1 => common::hid::KeyCode::,
		// Scan::App2 => common::hid::KeyCode::,
		_ => common::hid::KeyCode::X,
	}
}
	...
	fn on_event(&mut self, _s: &mut PixState, event: &Event) -> PixResult<bool> {
		match event {
			Event::KeyUp {
				...
				self.sender.send(AppEvent::KeyUp(*scan)).unwrap();
				Ok(true)
			}
			Event::KeyDown {
				// key: Some(key),
				...
				self.sender.send(AppEvent::KeyDown(*scan)).unwrap();
				Ok(true)
			}
			_ => Ok(false),
		}
